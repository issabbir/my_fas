            ...
            <form id="invoice-bill-receipt-form" enctype="multipart/form-data"
                ...
                <fieldset class="border p-2 mt-2">
                    ...
                    <div class="row">
                        ...
                        <label for="document_reference" class="col-md-3 col-form-label text-right">Document Ref</label>
                        <div class="col-md-5">
                ...
                <fieldset class="border pl-1 pr-1 mt-2">
                    ...
                    {{-- TODO: Add this part end: Pavel-22-08-22 --}}
                        ...
                        <table class="table table-sm table-bordered table-striped" id="inv_ref_table">
                            ...
                            <tfoot class="thead-light">
                                <tr class="font-small-3">
                                    ...
                                    <th id="total_receipt_amt" class="text-right">0</th>
                                </tr>
                                <tr class="font-small-3">
                ...
                <fieldset class="border p-2 mt-2">
                        ...
                        <div class="col-md-6 form-group pl-0">
                            <select class="custom-select form-control form-control-sm select2" name="receipt_instrument"
                                ...
                                @foreach($receiptMethods as $value)
                                    <option value="{{$value->instrument_type_id}}"{{ ($value->instrument_type_id == \App\Enums\Ar\LArReceiptMethods::CHALLAN_PO) ? "selected" : '' }} >{{$value->receipt_method_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group pl-0">
                            <input type="text" id="challan_amount" class="form-control form-control-sm"
                                   maxlength="17"
...
@section('footer-script')
    <script type="text/javascript">
        ...
        function getCustomerDetail(customer_id) {
            ...
            request.done(function (d) {
                if ($.isEmptyObject(d)) {
                    ...
                    $('#customer_name').val(d.customer.customer_name);
                    $('#customer_category').val(d.customer.customer_category_name);
                    $('#customer_bills_receivable').val(d.customer.os_bill_receivable);
       ...
       /***  Add this part start: Pavel-22-08-22 ***/
        ...
        /***  Add this part end: Pavel-22-08-22 ***/
        ...
        function getInvRefTotal(isInit, selector) {
            ...
            if (totalReceiptAmt == 0) {
                ...
                $('#challan_amount').val('0'); //Add this part: Pavel-22-08-22
                ...
                /** Add this part : Pavel-25-04-22 **/
                $('#challan_amount').val(totalReceiptAmt.toFixed(2)); //Add this part: Pavel-22-08-22
        ...
        $(document).ready(function () {
            ...
            receiptSearch();
            invRefList();
            tableSearchAllColumns(); //Add this part: Pavel-22-08-22
            customerList();
            bankAcc();
