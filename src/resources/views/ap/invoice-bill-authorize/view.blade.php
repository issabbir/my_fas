    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header d-flex justify-content-between align-items-center p-0">
                ...
                <a href="{{route('invoice-bill-authorize.index',['filter'=>(isset($filter) ? $filter : '')])}}"><span
                        class="badge badge-primary font-small-4"><i class="bx bx-log-out font-small-3 align-middle"></i> Back</span></a>
            </div>
            ...
            <form id="invoice-bill-authorize-form"
                  @if(isset($wkMapId)) action="{{route('invoice-bill-authorize.approve-reject-store',['wkMapId'=>$wkMapId,'filter'=>(isset($filter) ? $filter : '')])}}"
                  @endif method="post">
                @csrf
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row justify-content-end">
                                <label for="bill_section" class="required col-md-4 col-form-label">Employee Type</label>
                                <div class="col-md-5 pl-0">
                            ...
                            <div class="form-group row justify-content-end">
                                <label for="employee_type_name" class="required col-md-4 col-form-label">Bill Section</label>
                                <div class="col-md-5 pl-0">
                                    <input type="text" readonly class="form-control form-control-sm" name="employee_type_name"
                ...
                @endif--}}
                @if (isset($inserted_data->invoice_budget) && count($inserted_data->invoice_budget)!=0)
                    <fieldset class="border pl-1 pr-1">
                        <legend class="w-auto" style="font-size: 15px;">Budget Head Info
                        </legend>
                        <div class="row ">
                            <div class="col-md-12 table-responsive">
                                <table class="table table-sm table-hover table-bordered " id="account_table">
                                    ...
                                    <tr>
                                        <th width="30%" class="text-center">Head ID</th>
                                        <th width="40%" class="text-center">Head Name</th>
                                        <th width="30%" class="text-center">Budget Amount</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse($inserted_data->invoice_budget as $key => $value)
                                        <tr>
                                            <td style="padding: 2px;">
                                                <input tabindex="-1" name="addLineBudget[{{$key}}][b_head_id]"
                                                       id="b_head_id{{$key}}" class="form-control form-control-sm"
                                                       value="{{ $value->budget_head_id }}" readonly/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][budget_dept_id]"
                                                       id="budget_dept_id{{$key}}"
                                                       value="{{ $value->budget_dept_id }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][budget_trans_id]"
                                                       id="budget_trans_id{{$key}}"
                                                       value="{{ $value->budget_trans_id }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][bzt_add_action_type]"
                                                       id="bzt_action_type{{$key}}" value="A"/>
                                                ...
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][b_head_id]" id="b_head_id{{$key}}"
                                                       value="{{ $value->budget_head_id }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][b_head_name]"
                                                       id="b_head_name{{$key}}" value="{{ $value->budget_head_name }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][b_sub_category]"
                                                       id="b_sub_category{{$key}}"
                                                       value="{{ $value->budget_sub_category_name }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][b_category]"
                                                       id="b_category{{$key}}"
                                                       value="{{ $value->budget_category_name }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][b_type]" id="b_type{{$key}}"
                                                       value="{{ $value->budget_type_name }}"/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][booking_amt]"
                                                       id="booking_amt{{$key}}" value=""/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][utilized_amt]"
                                                       id="utilized_amt{{$key}}" value=""/>
                                                <input tabindex="-1" type="hidden"
                                                       name="addLineBudget[{{$key}}][available_amt]"
                                                       id="available_amt{{$key}}" value=""/>
                                            </td>
                                            <td style="padding: 2px;"><input tabindex="-1" id="b_head_name{{$key}}"
                                                                             type="text"
                                                                             class="form-control form-control-sm"
                                                                             readonly
                                                                             value="{{ $value->budget_head_name }}">
                                            </td>
                                            <td style="padding: 2px;"><input tabindex="-1" id="budget_amt{{$key}}"
                                                                             name="addLineBudget[{{$key}}][budget_amt]"
                                                                             type="text"
                                                                             class="form-control form-control-sm debit"
                                                                             readonly
                                                                             value="{{ $value->budget_utilize_amt }}">
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="total_debit" id="total_debit"
                                                   value="{{isset($inserted_data->invoice_budget)? $inserted_data->invoice_budget[0]->total_budget_utilize_amt : ''}}"
                                                   class="form-control form-control-sm text-right-align" readonly
                                                   tabindex="-1"/>
                                        </td>
                                        <td></td>
                                    </tr>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group row d-flex justify-content-end">
                                <div class="col-md-11">
                                    <input readonly type="text" class="form-control form-control-sm"
                                           id="party_name_for_tax"
                                           value="{{isset($inserted_data->tax_party_name) ? $inserted_data->tax_party_name : 'N/A' }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group row d-flex justify-content-end">
                                <div class="col-md-11">
                                    <input readonly type="text" class="form-control form-control-sm"
                                           id="party_name_for_vat"
                                           value="{{isset($inserted_data->vat_party_name) ? $inserted_data->vat_party_name : 'N/A'}}"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <label class="col-form-label " for="ap_payment_method">Payment
                                Method</label>
                            <input  name="ap_payment_method" value="{{$inserted_data->payment_methods_name}}"
