<form id="invoice_bill_entry_form" action="#" method="post" enctype="multipart/form-data">
    ...
    <fieldset class="border pl-1 pr-1">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row d-flex justify-content-end">
                    <label for="emp_type_id" class="col-md-4 col-form-label">Employee Type</label>
                    <div class="col-md-6">
                        <select name="emp_type_id" class="form-control form-control-sm" disabled
                                id="emp_type_id">
                            <option value="">&lt;Select&gt;</option>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="bl_bills_payable" class="form-control form-control-sm text-right"
                           name="bl_bills_payable" placeholder="" tabindex="-1" readonly>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="bl_provision_exp" class="form-control form-control-sm text-right"
                           name="bl_provision_exp" placeholder="" tabindex="-1" readonly>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="bl_security_dep_pay" class="form-control form-control-sm text-right"
                           name="bl_security_dep_pay" placeholder="" tabindex="-1" readonly>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="bl_os_advances" class="form-control form-control-sm text-right"
                           name="bl_os_advances" placeholder="" tabindex="-1" readonly>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="bl_os_prepayments" class="form-control form-control-sm text-right"
                           name="bl_os_prepayments" placeholder="" tabindex="-1" readonly>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" id="bl_os_imp_rev" class="form-control form-control-sm text-right"
                           name="bl_os_imp_rev" placeholder="" tabindex="-1" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 po_base_invoice">
                <div class="form-group row">
                    ...
                    <input type="text" id="ap_purchase_order_no" tabindex="-1" readonly
        ...
        <div class="form-group row po_base_invoice">
            <div class="offset-5 col-md-4">
                <div class="form-group row">
                    ...
                    <input type="text" id="ap_purchase_order_date" tabindex="-1" readonly
                           class="form-control form-control-sm col-md-8"
    ...
    <fieldset class="border pl-1 pr-1">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                <input tabindex="-1" readonly required value="1" class="form-control form-control-sm" id="ap_exchange_rate"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                <input tabindex="-1" readonly type="text" class="form-control form-control-sm text-right-align"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-5">
                    <textarea tabindex="-1" readonly class="form-control form-control-sm" id="ap_amount_word_ccy"></textarea>
            </div>
            <div class="col-md-4">
                <div class="form-check">
        ...
        <div class="form-group row">
                ...
                <div class="row">
                    <div class="col-md-3 pr-0">
                        ...
                        <input type="text" class="form-control form-control-sm text-right-align"
                               tabindex="-1" readonly oninput="maxLengthValid(this);this.value = this.value.match(/\d+\.?\d{0,2}/);"
                    ...
                    <div class="col-md-9">
                        ...
                        <input tabindex="-1" readonly class="form-control form-control-sm text-right-align"
                               id="ap_tax_amount_ccy"
            ...
            <div class="col-md-4">
                <select name="party_name_for_tax" id="party_name_for_tax" tabindex="-1"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <select name="party_name_for_vat" id="party_name_for_vat" tabindex="-1"
                        class="form-control form-control-sm make-readonly-bg">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <button class="btn btn-sm btn-primary additional-account-btn" data-toggle="modal"
                                ...
                                id="add_account" type="button"><i class="bx bxs-add-to-queue"></i>
                        </button>
                    </div>
                    <div class="col-md-9">
                        {{--<input readonly type="number" min="0"
    ...
    <fieldset class="border pl-1 pr-1 additional-account-area d-none">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-7">
                        <button class="btn btn-dark btn-sm float-right" id="ap_add_cancel_account" type="button" tabindex="-1">
                            <i class="bx bx-x font-size-small"></i>
                            <span class="align-middle ">Remove Additional Accounts</span>
                        </button>
                    </div>
                    <div class="col-md-3">
                        <button class="btn btn-sm btn-warning float-right minimizeAdditionalArea" type="button">Minimize</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row  payableArea hidden mb-1 mt-1`">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row ">
                            <label class=" col-md-3 col-form-label" for="ap_add_party_sub_ledger">Party
                                Sub-Ledger</label>
                            <select class="form-control form-control-sm col-md-9" name="ap_add_party_sub_ledger"
                                    id="ap_add_party_sub_ledger">
                                <option value="">&lt;Select&gt;</option>
                        ...
                        <div class="row ">
                            ...
                            <input name="ap_add_vendor_id" class="form-control form-control-sm col-md-3" value=""
                                   type="number"
                                   id="ap_add_vendor_id"
                                   maxlength="10"
                                   onfocusout="addZerosInAccountId(this)"
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-sm btn-primary vendorIdAddSearch" id="ap_add_vendor_search"
                                        type="button"
                                        tabindex="-1"><i class="bx bx-search font-size-small"></i><span
                                        class="align-middle ml-25">Search</span>
                                </button>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row ">
                            <label for="ap_add_vendor_category" class="col-md-3 col-form-label">Party/Vendor
                                Category</label>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="input-group col-md-6 pl-0 pr-0">
                                ...
                                <input class="form-control form-control-sm text-right-align"
                                       id="ap_add_account_balance" style="height: auto"
                                       name="ap_add_account_balance"
                                       type="text" tabindex="-1" readonly>
                                <div class="input-group-append">
                                        <span class="input-group-text" style="font-size: 13px"
                                              id="ap_add_account_balance_type"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                            <label class="col-md-5 col-form-label" for="ap_add_authorized_balance">Authorized
                                Balance</label>
                            <div class="input-group col-md-6 pl-0 pr-0">
                                <input name="ap_add_authorized_balance"
                                       class="form-control form-control-sm text-right-align"
                                       value="" style="height: auto"
                                       id="ap_add_authorized_balance" tabindex="-1" readonly>
                                <div class="input-group-append">
                                    <span class="input-group-text" style="font-size: 13px"
                                          id="ap_add_authorized_balance_type"></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row  receivableArea hidden mb-1 mt-1`">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row ">
                            <label class=" col-md-3 col-form-label" for="ar_add_party_sub_ledger">Party
                                Sub-Ledger</label>
                            <select class="form-control form-control-sm col-md-9" name="ap_add_party_sub_ledger"
                                    id="ar_add_party_sub_ledger">
                                <option value="">&lt;Select&gt;</option>
                                {{--@foreach($apSubsidiaryType as $type)
                                    <option
                                        value="{{$type->gl_subsidiary_id}}" {{ (old('ap_party_sub_ledger', isset($data['insertedData']) ? $data['insertedData']->gl_subsidiary_id : '' ) == $type->gl_subsidiary_id) ? 'Selected' : '' }}>{{$type->gl_subsidiary_name}}</option>
                        ...
                        <div class="row ">
                            ...
                            <input name="ap_add_vendor_id" class="form-control form-control-sm col-md-3" value=""
                                   ...
                                   oninput="maxLengthValid(this)">
                            <div class="col-md-3">
                                <button class="btn btn-sm btn-primary customerIdAddSearch" id="ar_customer_search"
                                        type="button"
                                        tabindex="-1"><i class="bx bx-search font-size-small"></i><span
                                        class="align-middle ml-25">Search</span>
                                </button>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row ">
                            <label for="ar_add_customer_name" class="col-md-3 col-form-label">Party/Customer
                                Name</label>
                            <input name="ap_add_vendor_name" class="form-control form-control-sm col-md-9" value=""
                        ...
                        <div class="row ">
                            <label for="ar_add_customer_category" class="col-md-3 col-form-label">Party/Customer
                                Category</label>
                            <input name="ap_add_vendor_category" class="form-control form-control-sm col-md-9" value=""
                    ...
                    <div class="col-md-4">
                        <div class="form-group row ">
                            ...
                            <div class="input-group col-md-6 pl-0 pr-0">
                                <input class="form-control form-control-sm text-right-align"
                                       id="ar_add_account_balance" style="height: auto;"
                                       name="ap_add_account_balance"
                                       type="text" tabindex="-1" readonly>
                                <div class="input-group-append">
                                    <span class="input-group-text" style="font-size: 13px;"
                                          id="ar_add_account_balance_type"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                            <label class="col-md-5 col-form-label" for="ar_add_authorized_balance">Authorized
                                Balance</label>
                            <div class="input-group col-md-6 pl-0 pr-0">

                                <input name="ap_add_authorized_balance" style="height: auto;"
                                       class="form-control form-control-sm text-right-align"
                                       value="" tabindex="-1"
                                       id="ar_add_authorized_balance" readonly>
                                <div class="input-group-append">
                                    <span class="input-group-text" style="font-size: 13px"
                                          id="ar_add_authorized_balance_type"></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <div class="input-group date ap_payment_due_date"
                     ...
                     data-target-input="nearest">
                    <input required type="text" autocomplete="off" onkeydown="return false" tabindex="-1" readonly
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control form-control-sm " id="ap_hold_all_payment_reason"
                       name="ap_hold_all_payment_reason" tabindex="-1" readonly>
            </div>
        </div>
    </fieldset>
    ...
    {{--<fieldset class="swt_pay_party_vendor_div d-none border pl-1 pr-1">
        <legend class="w-auto" style="font-size: 15px;">Switch Payment to Party/Vendor (Contra & Supplier For Provision Adjustment)
        </legend>
        <div class="form-group row">
    ...
    <div class="budget_booking_utilized_div d-none">
        <fieldset class="border pl-1 pr-1">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <select name="budget_department" class="form-control form-control-sm select2" style="width: 100%!important;" id="budget_department">
                        <option value="">&lt;Select&gt;</option>
                        @foreach($department as $dpt)
                            <option
                                {{  old('budget_department') ==  $dpt->cost_center_dept_id ? "selected" : "" }} value="{{$dpt->cost_center_dept_id}}"> {{ $dpt->cost_center_dept_name}} </option>
                ...
                <div class="col-md-4 ml-2">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value={{\App\Enums\YesNoFlag::YES}} name="ap_without_budget_info"
    ...
    <div class="distribution_line_div ">
        <input type="hidden" name="ap_distribution_flag" value="2" id="ap_distribution_flag">
        <fieldset class=" border p-2">
            ...
            <div class="form-group row">
                ...
                <div class="row col-md-6 pl-0 mr-1">
                    <div class="input-group col-md-5">
                        <input tabindex="-1" readonly name="ap_account_id" class="form-control form-control-sm" value="" type="number"
                               id="ap_account_id" oninput="maxLengthValid(this)"
                               onfocusout="addZerosInAccountId(this)"
                               onkeyup="resetAccountField()">
                    </div>
                    <div class="col-md-5">
                        <button class="btn btn-primary btn-sm searchAccount" id="ap_search_account" type="button"
                                tabindex="-1"><i class="bx bx-search font-size-small"></i>
                            <span class="align-middle ">Search</span>
                        </button>
                    </div>
                ...
                <div class="input-group col-md-2 pl-0">
                    <input class="form-control form-control-sm text-right-align" id="ap_account_balance"
                           tabindex="-1" style="height: auto"
                           name="ap_account_balance"
                           type="text" readonly>
                    <div class="input-group-append">
                        <span class="input-group-text" style="font-size: 13px" id="ap_account_balance_type"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="input-group col-md-2 pl-0">
                    <input name="ap_authorized_balance" style="height: auto;"
                           ...
                           id="ap_authorized_balance" readonly>
                    <div class="input-group-append">
                        <span class="input-group-text" style="font-size: 13px" id="ap_authorized_balance_type"></span>
                    </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="row distVendorArea hidden  mb-1 mt-1">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row ">
                                <label class=" col-md-3 col-form-label" for="ap_dist_party_sub_ledger">Party
                                    Sub-Ledger</label>
                                <select class="form-control form-control-sm col-md-9" name="ap_dist_party_sub_ledger"
                                        id="ap_dist_party_sub_ledger">
                                    <option value="">&lt;Select&gt;</option>
                                    {{--@foreach($apSubsidiaryType as $type)
                                        <option
                                            value="{{$type->gl_subsidiary_id}}" {{ (old('ap_party_sub_ledger', isset($data['insertedData']) ? $data['insertedData']->gl_subsidiary_id : '' ) == $type->gl_subsidiary_id) ? 'Selected' : '' }}>{{$type->gl_subsidiary_name}}</option>
                            ...
                            <div class="row ">
                                ...
                                <input name="ap_dist_vendor_id" class="form-control form-control-sm col-md-3" value=""
                                       type="number"
                                       ...
                                       oninput="maxLengthValid(this)">
                                <div class="col-md-3">
                                    <button class="btn btn-sm btn-primary vendorIdDistSearch" id="ap_dist_vendor_search"
                                            type="button"
                                            tabindex="-1"><i class="bx bx-search font-size-small"></i><span
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row ">
                                <label for="ap_dist_vendor_name" class="col-md-3 col-form-label">Party/Vendor
                                    Name</label>
                            ...
                            <div class="row ">
                                <label for="ap_dist_vendor_category" class="col-md-3 col-form-label">Party/Vendor
                                    Category</label>
                                <input name="ap_dist_vendor_category" class="form-control form-control-sm col-md-9"
                                       value=""
                        ...
                        <div class="col-md-4">
                            <div class="form-group row ">
                                <label class="col-form-label col-md-5" for="ap_dist_account_balance">Account
                                    Balance</label>
                                <div class="input-group col-md-6 pl-0 pr-0">
                                    <input class="form-control form-control-sm text-right-align"
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text" style="font-size: 13px"
                                              id="ap_dist_account_balance_type"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row ">
                                <label class="col-md-5 col-form-label" for="ap_dist_authorized_balance">Authorized
                                    Balance</label>
                                <div class="input-group col-md-6 pl-0 pr-0">
                                    <input name="ap_dist_authorized_balance" style="height: auto;"
                                           class="form-control form-control-sm text-right-align"
                                           value="" tabindex="-1"
                                           id="ap_dist_authorized_balance" readonly>
                                    <div class="input-group-append">
                                        <span class="input-group-text" style="font-size: 13px"
                                              id="ap_dist_authorized_balance_type"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row distCustomerArea hidden mb-1 mt-1`">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row ">
                                <label class=" col-md-3 col-form-label" for="ar_dist_party_sub_ledger">Party
                                    Sub-Ledger</label>
                                <select class="form-control form-control-sm col-md-9" name="ap_dist_party_sub_ledger"
                                        id="ar_dist_party_sub_ledger">
                                    <option value="">&lt;Select&gt;</option>
                                    {{--@foreach($apSubsidiaryType as $type)
                                        <option
                                            value="{{$type->gl_subsidiary_id}}" {{ (old('ap_party_sub_ledger', isset($data['insertedData']) ? $data['insertedData']->gl_subsidiary_id : '' ) == $type->gl_subsidiary_id) ? 'Selected' : '' }}>{{$type->gl_subsidiary_name}}</option>
                            ...
                            <div class="row ">
                                <label class=" col-md-3 col-form-label" for="ar_dist_customer_id">Party/Customer
                                    ID</label>
                                <input name="ap_dist_vendor_id" class="form-control form-control-sm col-md-3" value=""
                                       type="number"
                                ...
                                >
                                <div class="col-md-3">
                                    <button class="btn btn-sm btn-primary customerIdistSearch"
                                            id="ar_dist_customer_search" type="button"
                                            tabindex="-1"><i class="bx bx-search font-size-small"></i><span
                                            class="align-middle ml-25">Search</span>
                                    </button>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row ">
                                <label for="ar_dist_customer_name" class="col-md-3 col-form-label">Party/Customer
                                    Name</label>
                                <input name="ap_dist_vendor_name" class="form-control form-control-sm col-md-9" value=""
                            ...
                            <div class="row ">
                                <label for="ar_dist_customer_category" class="col-md-3 col-form-label">Party/Customer
                                    Category</label>
                                <input name="ap_dist_vendor_category" class="form-control form-control-sm col-md-9"
                                       value=""
                        ...
                        <div class="col-md-4">
                            <div class="form-group row ">
                                <label class="col-form-label col-md-5" for="ar_add_account_balance">Account
                                    Balance</label>
                                <div class="input-group col-md-6 pl-0 pr-0">
                                    <input class="form-control form-control-sm text-right-align"
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text" style="font-size: 13px;"
                                              id="ar_dist_account_balance_type"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row ">
                                <label class="col-md-5 col-form-label" for="ar_dist_authorized_balance">Authorized
                                    Balance</label>
                                <div class="input-group col-md-6 pl-0 pr-0">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text" style="font-size: 13px"
                                              id="ar_dist_authorized_balance_type"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        {{--<input readonly class="required form-control form-control-sm col-md-4 text-right-align"
                               ...
                               type="number">--}}
                        <input tabindex="-1" readonly class="required form-control form-control-sm col-md-4 text-right-align"
                               id="ap_amount_ccy"
                               maxlength="17"
                               oninput="maxLengthValid(this);this.value = this.value.match(/\d+\.?\d{0,2}/);"
                               name="ap_amount_ccy"
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <button class="btn btn-info btn-sm" type="button" tabindex="-1" onclick="addLineRow(this)"
                            data-type="A"
            ...
            <div class="row">
                <label class="col-form-label col-md-2" for="ap_amount_word">In Words</label>
