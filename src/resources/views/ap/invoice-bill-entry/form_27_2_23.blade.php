    ...
    <div class="budget_booking_utilized_div d-none">
        <fieldset class="border pl-1 pr-1">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <input type="text" tabindex="-1" readonly class="form-control form-control-sm text-right" name="b_amt"
                           id="b_amt"
                           value="">
                </div>
                ...
                <div class="col-md-2">
                    <input type="text" tabindex="-1" readonly class="form-control form-control-sm text-right" name="b_utilized_amt"
                           id="b_utilized_amt"
                           value="">
                </div>
                {{--Add this section end Pavel: 24-03-22--}}
                ...
                <div class="col-md-2">
                    <input type="text" tabindex="-1" readonly class="form-control form-control-sm text-right" name="b_available_amt"
                           id="b_available_amt"
                           value="">
                </div>
            </div>
