...
class InvoiceBillAuthorizeController extends Controller
{
    ...
    public function searchInvoiceBillAuthorize(Request $request)
    {
        ...
        $data = DB::select("select cpaacc.fas_ap_trans.get_ap_invoice_auth_list (:p_trans_period_id,:p_bill_sec_id,:p_bill_reg_id,:p_workflow_approval_status,:p_user_id) from dual",["p_trans_period_id" => $period,"p_bill_sec_id" => $billSection,"p_bill_reg_id" => $billReg,"p_workflow_approval_status" => $approvalStatus,"p_user_id" => $user_id]);
